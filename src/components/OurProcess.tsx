...
const OurProcess: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      description:
        "Accurate measurements ensure your furniture fits perfectly, maximizing space and functionality.",
      imgSrc:
    ...
    },
    {
        ...
        description:
          "Your order is carefully reviewed and processed to ensure all details are correct before moving to production.",
        imgSrc:
  ...
  return (
    <div className="bg-white px-6 py-12 mb-2">
      {/* Section Title */}
      <h2 className="text-4xl font-bold text-center mb-12 font-playfair">Our Process</h2>

      {/* Process Steps */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto animate__animated animate__slideInLeft">
        {steps.map((step, index) => (
          ...
          >
            ...
            <img
              src={step.imgSrc}
              alt={step.title}
              className="w-36 h-36 flex-shrink-0 rounded-lg shadow-md"
            />
            {/* Text */}
            <div>
              <h3 className="text-xl font-bold mb-2 font-playfair">{step.title}</h3>
